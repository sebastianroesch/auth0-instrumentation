 ...
 */
export class Auth0SentryStream {
  public client: any;
   ...
   */
  public write(record: { level: number; tags?: any; log_type?: string; err?: any; msg?: string }): boolean {
   ...
   */
  public getSentryLevel(record: { level: number }) {
   ...
   */
  public deserializeError(data: any) {
    if (data instanceof Error) {
      return data;
    }

    const error = new SentryError(data.message);
 ...
 */
export function defaultSetup(client, level) {
  return {
